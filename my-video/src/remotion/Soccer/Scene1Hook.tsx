    ...
    >
      ...
      <div
        style={{
          ...
          opacity: 0.03,
          backgroundImage: `
            linear-gradient(90deg, ${SOCCER_COLORS.text} 1px, transparent 1px),
            linear-gradient(0deg, ${SOCCER_COLORS.text} 1px, transparent 1px)
          `,
      ...
      <div
        style={{
          ...
          height: 400,
          borderRadius: '50%',
          border: `2px solid ${SOCCER_COLORS.text}`,
          opacity: 0.02,
        }}
      />
      ...
      >
        ...
        >
          ...
          >
            Running a soccer training business
          </div>
        </div>
