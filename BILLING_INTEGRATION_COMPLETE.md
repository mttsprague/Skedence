...
**File**: [PolyCal/PolyCal/AuthManager.swift](PolyCal/PolyCal/AuthManager.swift)
...
**File**: [PolyCal/functions/src/index.ts](PolyCal/functions/src/index.ts)
...
**File**: [PolyCal/PolyCal/ScheduleView.swift](PolyCal/PolyCal/ScheduleView.swift)
...
**File**: [PolyCal/PolyCal/ContentView.swift](PolyCal/PolyCal/ContentView.swift)
...
The following files need to be added to the PolyCal Xcode project:

1. Open `PolyCal.xcodeproj` in Xcode
2. Right-click on the `PolyCal` folder in the project navigator
3. Select **"Add Files to PolyCal..."**
4. Navigate to the PolyCal folder and select:
...
```bash
cd "/Users/matthewsprague/Documents/GitHub/Polyface Volleyball Academy/PolyCal/functions"
...
3. Fill in:
   ...
   - **Description**: PolyCal Platform Billing
