...
struct SkedenceApp: App {
    ...
    private func handleDeepLink(_ url: URL) {
        ...
        // 🏷️ WHITE-LABEL: Organization code deep linking removed
        // Deep link infrastructure kept for potential future use
...
class DeepLinkManager: ObservableObject {
    // 🏷️ WHITE-LABEL: Organization code fields removed
    // Infrastructure kept for potential future deep links
}
