...
#Preview("Paywall Banner") {
    PaywallBanner(
        ...
        print("Update subscription tapped")
    }
}

#Preview("Paywall Modal") {
    PaywallModal(
        message: "Your subscription has expired. Please update your payment method to continue using this app."
    ) {
        print("Update subscription tapped")
    }
}
