                                ...
                                Link(destination: URL(string: "mailto:Jeff@polyfacevolleyball.com")!) {
                                    HStack(spacing: Spacing.md) {
                                        ...
                                        VStack(alignment: .leading, spacing: Spacing.xxs) {
                                            ...
                                            Text("Jeff@polyfacevolleyball.com")
                                                .font(.bodyMedium)
                                                .foregroundStyle(AppTheme.primary)
                                        }
                    ...
                    VStack(alignment: .leading, spacing: Spacing.md) {
                        ...
                        CardView {
                            VStack(alignment: .leading, spacing: Spacing.md) {
                                ...
                                Text("The official booking app for PolyFace Volleyball Academy. Easily schedule lessons, manage your training packages, and stay connected with your coaches.")
                                    .font(.bodySmall)
                                    .foregroundStyle(AppTheme.textSecondary)
