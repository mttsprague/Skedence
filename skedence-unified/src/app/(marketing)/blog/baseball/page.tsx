...
export const metadata: Metadata = {
  title: 'Baseball Coaching Articles & Tips | Skedence Blog',
  description:
    'Baseball coaching tips, pitching and hitting drills, scheduling strategies, and business advice for private baseball coaches and academies.',
  keywords: [
    'baseball coaching tips',
    'baseball training drills',
    'baseball lesson scheduling',
    'baseball coach software',
    'baseball academy management',
  ],
  alternates: { canonical: 'https://skedence.com/blog/baseball' },
  openGraph: {
    title: 'Baseball Coaching Articles & Tips | Skedence Blog',
    description:
      'Baseball coaching tips, pitching and hitting drills, and business advice for private baseball coaches and academies.',
    url: 'https://skedence.com/blog/baseball',
    siteName: 'Skedence',
    type: 'website',
    images: [{ url: 'https://skedence.com/og-baseball.png', width: 1200, height: 630 }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Baseball Coaching Articles & Tips | Skedence Blog',
    description:
      'Baseball coaching tips, pitching and hitting drills, and business advice for private baseball coaches.',
    images: ['https://skedence.com/og-baseball.png'],
  },
};

export default async function BaseballBlogPage() {
  const posts = await fetchPostsBySport('baseball');

  const collectionPageJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'CollectionPage',
    name: 'Baseball Coaching Articles | Skedence Blog',
    description:
      'Baseball coaching tips, pitching and hitting drills, and business advice for private baseball coaches.',
    url: 'https://skedence.com/blog/baseball',
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-40 pb-16 px-6 overflow-hidden">
        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
            <span className="text-xs font-bold text-primary tracking-widest uppercase">⚾ Baseball</span>
          </div>
          <h1 className="text-5xl md:text-6xl font-black tracking-tight text-foreground uppercase leading-tight mb-4">
            Baseball<br />Coaching Articles
          </h1>
          <p className="text-xl text-foreground/60 max-w-2xl">
            Pitching and hitting drills, scheduling tips, and business advice for private baseball coaches.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-6xl">
          {posts.length === 0 ? (
            <div className="text-center py-20">
              <p className="text-xl text-foreground/60">No baseball articles yet. Check back soon!</p>
            </div>
          ) : (
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-background to-muted/20">
        <div className="container mx-auto max-w-3xl text-center space-y-6">
          <h2 className="text-4xl font-black text-foreground uppercase">Manage Your Baseball Business</h2>
          <p className="text-lg text-foreground/60">Scheduling, lesson packages, and payments — all in one app built for baseball coaches.</p>
          <Link href="/baseball" className="btn-premium inline-flex items-center gap-2">
            See Baseball Features <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
      </section>
