...
export const metadata: Metadata = {
  title: 'Soccer Coaching Articles & Tips | Skedence Blog',
  description:
    'Soccer coaching tips, training drills, scheduling strategies, and business advice for private soccer trainers, clubs, and academies.',
  keywords: [
    'soccer coaching tips',
    'soccer training drills',
    'soccer lesson scheduling',
    'soccer trainer software',
    'soccer coach business',
  ],
  alternates: { canonical: 'https://skedence.com/blog/soccer' },
  openGraph: {
    title: 'Soccer Coaching Articles & Tips | Skedence Blog',
    description:
      'Soccer coaching tips, training drills, and business advice for private soccer trainers and clubs.',
    url: 'https://skedence.com/blog/soccer',
    siteName: 'Skedence',
    type: 'website',
    images: [{ url: 'https://skedence.com/og-soccer.png', width: 1200, height: 630 }],
  },
  twitter: {
...
export default async function SoccerBlogPage() {
  const posts = await fetchPostsBySport('soccer');

  const collectionPageJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'CollectionPage',
    name: 'Soccer Coaching Articles | Skedence Blog',
    description:
      'Soccer coaching tips, training drills, and business advice for private soccer trainers and clubs.',
    url: 'https://skedence.com/blog/soccer',
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-40 pb-16 px-6 overflow-hidden">
        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
            <span className="text-xs font-bold text-primary tracking-widest uppercase">⚽ Soccer</span>
          </div>
          <h1 className="text-5xl md:text-6xl font-black tracking-tight text-foreground uppercase leading-tight mb-4">
            Soccer<br />Coaching Articles
          </h1>
          <p className="text-xl text-foreground/60 max-w-2xl">
            Training drills, scheduling tips, and business advice for private soccer trainers and clubs.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-6xl">
          {posts.length === 0 ? (
            <div className="text-center py-20">
              <p className="text-xl text-foreground/60">No soccer articles yet. Check back soon!</p>
            </div>
          ) : (
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-background to-muted/20">
        <div className="container mx-auto max-w-3xl text-center space-y-6">
          <h2 className="text-4xl font-black text-foreground uppercase">Manage Your Soccer Business</h2>
          <p className="text-lg text-foreground/60">Scheduling, training packages, and payments — all in one app built for soccer trainers.</p>
          <Link href="/soccer" className="btn-premium inline-flex items-center gap-2">
            See Soccer Features <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
      </section>
