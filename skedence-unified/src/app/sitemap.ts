...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: 'https://skedence.com/blog/volleyball', changeFrequency: 'weekly', priority: 0.7 },
    { url: 'https://skedence.com/blog/basketball', changeFrequency: 'weekly', priority: 0.7 },
    { url: 'https://skedence.com/blog/soccer', changeFrequency: 'weekly', priority: 0.7 },
    { url: 'https://skedence.com/blog/baseball', changeFrequency: 'weekly', priority: 0.7 },
