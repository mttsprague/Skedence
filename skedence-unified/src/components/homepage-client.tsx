      ...
      <section className="relative pt-40 pb-32 px-6 overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="max-w-4xl space-y-10">
            ...
            <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-foreground/70 uppercase">
              Sports Coaching Scheduling Software
            </h1>

            <p className="text-6xl md:text-8xl font-black tracking-tight text-foreground leading-[0.95] uppercase">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="premium-card p-10 space-y-8 flex flex-col">
              ...
              <ul className="space-y-4 flex-1">
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">1 trainer account</span></li>
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">1 location</span></li>
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">Unlimited clients</span></li>
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">Payment processing</span></li>
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">Email support</span></li>
              </ul>
            ...
            <div className="premium-card p-10 space-y-8 flex flex-col relative border-2 border-primary shadow-[0_0_40px_rgba(255,107,53,0.3)]">
              ...
              <ul className="space-y-4 flex-1">
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">Up to 5 trainers</span></li>
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">3 locations</span></li>
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">Everything in Starter</span></li>
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">Group classes</span></li>
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">Priority support</span></li>
              </ul>
              <Link href="/register" className="btn-premium w-full text-center">Start Free Trial</Link>
            </div>
            ...
            <div className="premium-card p-10 space-y-8 flex flex-col">
              ...
              <ul className="space-y-4 flex-1">
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">Up to 15 trainers</span></li>
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">10 locations</span></li>
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">Everything in Studio</span></li>
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">API access</span></li>
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">Dedicated support</span></li>
              </ul>
              <Link href="/register" className="btn-premium w-full text-center">Start Free Trial</Link>
            </div>
            ...
            <div className="premium-card p-10 space-y-8 flex flex-col">
              ...
              <ul className="space-y-4 flex-1">
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">Unlimited trainers</span></li>
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">Unlimited locations</span></li>
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">White-label solution</span></li>
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">SLA guarantee</span></li>
                <li className="flex items-start gap-3 text-sm"><Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span className="text-foreground/70">Account manager</span></li>
              </ul>
