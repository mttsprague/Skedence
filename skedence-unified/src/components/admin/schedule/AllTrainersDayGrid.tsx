                    ...
                    {trainerClasses.map((classItem) => {
                      ...
                      return (
                        <div
                          ...
                          className="absolute left-1 right-1 bg-purple-500 hover:bg-purple-600 text-white rounded cursor-pointer transition-colors pointer-events-auto"
                          style={{
                            top: `${yOffset}px`,
                            height: `${Math.max(height, 20)}px`,
                          }}
